      ...
      <div className="max-w-3xl mx-auto px-5">
        <div className="flex items-center justify-between mb-5">
          ...
          >
            ...
            <span className="hidden sm:inline text-stone-600 font-semibold text-[11px] tracking-tight">찬양으로 잼잼한 하루</span>
            <span className="sm:hidden text-stone-600 font-semibold text-[11px] tracking-tight">찬양 잼잼</span>
          </a>
        </div>
